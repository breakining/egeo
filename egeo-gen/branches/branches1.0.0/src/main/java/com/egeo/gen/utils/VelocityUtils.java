...
public class VelocityUtils {
	...
	public static String getString(String template, ProEntity entity) {
		...
		ctx.put("zgxcwUtilsVersion", entity.getZgxcwUtilsVersion());
		ctx.put("zgxcwCoreVersion", entity.getZgxcwCoreVersion());
		ctx.put("zgxcwDubboVersion", entity.getZgxcwDubboVersion());
